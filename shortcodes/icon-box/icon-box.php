...
class dt_icon_box {
    ...
    public function dt_icon_box() {
        ...
        vc_map( array(
            ...
            "params" => array_merge(vc_iconfont_selections(),  array(
               ...
               ), dt_animation('bangladesh'),vc_typography_selections('Icon Box Title', 'dt_icon_box_title'),vc_typography_selections('Icon Box Description', 'dt_icon_box_dec'))
        ) );
    }
    ...
    */
    public function dt_icon_box_rander( $atts, $content = null ) {
      ...
      $output = dt_template_part('icon-box', null , $atts);
