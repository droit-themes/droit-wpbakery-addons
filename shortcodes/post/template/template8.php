...
<section class="blog_grid_area_two">
        <div class="container">
            <div class="row blog_grid_row">
                <?php foreach($get_post as $post) { ?> 
                <div class="col-lg-4 col-sm-6 blog_grid_col">
            ...
            <nav class="navigation pagination portfolio_pagination mt-0">
                <?php  Rave_helper()->pagination(); ?>
            </nav>
        </div>
    </section>
