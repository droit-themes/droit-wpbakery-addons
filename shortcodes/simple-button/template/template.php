...
$wrapper_class_list[] = 'd-flex justify-content-center align-items-center height-inherent';

if(isset($dt_simple_btn_icon_pos) && $dt_simple_btn_icon_pos == 'left') {
    $wrapper_class_list[] = 'flex-row-reverse';
}
